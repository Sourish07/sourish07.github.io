...
Let's say we're given $$n$$ data points represented as $$(x_i, y_i)$$, where $$0\le i <Cspost n$$. This means $$i$$ represents the data point's index. Our goal is to find the optimal weights, $$w_0$$ and $$w_1$$, based on the input data.
