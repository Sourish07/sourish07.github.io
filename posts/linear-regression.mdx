...
_How can we best predict the price of the final house given the data for the preceding houses?_ is the question we're trying to solve.
...
<video playsInline autoPlay muted loop>
  <source src="/blogAssets/images/lr/lr-anim.webm" type="video/webm"></source>
</video>

This algorithm also extends to lines of higher degrees (again, sped up).

<video playsInline autoPlay muted loop>
  <source src="/blogAssets/images/lr/quad.webm" type="video/webm"></source>
</video>

<video playsInline autoPlay muted loop>
  <source src="/blogAssets/images/lr/cubic.webm" type="video/webm"></source>
</video>
...
Let's say we're given $$n$$ data points represented as $$(x_i, y_i)$$, where $$0\le i <MultiLevelArticleContent n$$. This means $$i$$ represents the data point's index. Our goal is to find the optimal weights, $$w_0$$ and $$w_1$$, based on the input data.
...
<video playsInline autoPlay muted loop>
  <source
    src="/blogAssets/images/lr/contourplotwithline.webm"
    type="video/webm"
  ></source>
</video>
