...
<img src="/blogAssets/images/nn/7_2.svg" style={{maxHeight: "1000px"}}></img>
...
_Extending the analogy to the first model: One could say it's like a student that didn't bother studying at all!_
...
_The weights of the network are not tuned when the test data is passed in! This means that the model isn't learning from the test data so it'll be unable to "memorize" any of the test examples._
...
<img src="/blogAssets/images/nn/ReformattedNetwork.svg" style={{height: "300px"}}></img>
...
_The weights and biases are updated simultaneously after all the gradients have been calculated! Do not update the weights or biases as you calculate the gradients._
