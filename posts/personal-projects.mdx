...
_Using APIs are highly encouraged unless you're seeking to learn the specific skill the API abstracts away. All professional developers learn to get comfortable with using other people's code._
